...
@section('content_left')
    <div class="min-h-100 d-flex align-items-center">
        <div class="w-100 w-lg-75 w-xxl-50">
            <div>
                <div class="mb-5">
                    <h1 class="display-3 text-white">Realistic solutions for it</h1>
                ...
                <div class="mb-5">
                    <a class="btn btn-lg btn-outline-white" href="https://www.rs4it.com/">Learn More</a>
                </div>
            </div>
        </div>
    </div>
...
@section('content_right')
    <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
        <div class="sw-lg-50 px-5">
            ...
            <div>
                <form id="loginForm" method="post" action={{ route('add') }} class="tooltip-end-bottom" novalidate>
